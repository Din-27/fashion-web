    ...
    return (
        <div className="mt-6 space-y-4">
            <span className="flex items-center">
                <h4 className="text-lg font-bold">All Reviews</h4>
                <span>(451)</span>
            </span>
            <div
                className="py-6 px-8 bg-white border lg:w-80 w-full border-gray-200 rounded-lg shadow hover:bg-gray-100">
                ...
                <h5 className="flex items-center mb-2 text-xl font-bold tracking-tight text-gray-900">
            ...
            <button className="border rounded-full py-2 lg:w-1/3 w-full font-semibold">Load More</button>
        </div>
    )
}
